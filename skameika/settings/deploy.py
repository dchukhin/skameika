...
DATABASES["default"]["NAME"] = "skameika_%s" % ENVIRONMENT.lower()
DATABASES["default"]["USER"] = "skameika_%s" % ENVIRONMENT.lower()
DATABASES["default"]["HOST"] = os.environ.get("DB_HOST", "")
DATABASES["default"]["PORT"] = os.environ.get("DB_PORT", "")
DATABASES["default"]["PASSWORD"] = os.environ.get("DB_PASSWORD", "")

WEBSERVER_ROOT = "/var/www/skameika/"
...
EMAIL_SUBJECT_PREFIX = "[Skameika %s] " % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://skameika_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/skameika_%(ENVIRONMENT)s' % os.environ  # noqa
