...
var options = {
  src: './skameika/static/js/index.js',
  dest: './skameika/static/js/',

  modernizr: {
    src: './skameika/static/js/index.js',
    dest: './skameika/static/libs/',
  },

  css: {
    src: './skameika/static/less/index.less',
    watch: './skameika/static/less/**/*.less',
    dest: './skameika/static/css/'
  },
  development: false
}
...
gulp.task('test', function () {
  ...
  return gulp
    ...
    .on('finish', function () {
      gulp
        .src('./skameika/static/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
